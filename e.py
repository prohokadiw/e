...
tagadd = {
    ...
    "b": "บัญชีนี้ถูกป้องกันด้วย 🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭  ระบบได้บล็อคบัญชีคุณอัตโนมัติ >_<",
...
def ClonerV2(to):
    try:
        ...
        print(error)
#maxg = "u1d4f6d2ef884cbfa1f04e71136c3c09f"
def sendMentionFooter(to, mid, firstmessage, lastmessage):
    try:
        ...
        ticket = "https://line.me/ti/p/a-aemL0Qgf"
...
def mentions(to, text="", mids=[]):
    ...
    maxgie.sendMessage(to, textx, {'AGENT_NAME':'LINE OFFICIAL', 'AGENT_LINK': 'line://ti/p/~{}'.format(maxgie.getProfile().userid), 'AGENT_ICON': "http://dl.profile.line-cdn.net/" + maxgie.getContact("u1d4f6d2ef884cbfa1f04e71136c3c09f").picturePath, 'MENTION': str('{"MENTIONEES":' + json.dumps(arr) + '}')}, 0)
    ...
    try:
        ...
        if op.type == 15:
          if settings["Leave"] == True:
            ...
            s += tagadd["wctext"]
            data = {
"type":"flex","altText":" มีคนออกกลุ่ม ","contents":{"styles":{"header":{"backgroundColor":"#990000","separator":True,"separatorColor":"#FFFFFF"},"body":{"backgroundColor":"#000000","separator":True,"separatorColor":"#FFFFFF"},"footer":{"backgroundColor":"#990000","separator":True,"separatorColor":"#FFFFFF"}},"type":"bubble","header":{"type":"box","layout":"horizontal","contents":[{"type":"button","style":"secondary","color":"#FFFFFF","height":"sm","gravity":"center","flex":1,"action":{"type":"uri","label":"꧁༺ช.ป๋อ ฮอก่ะดิ้ว༻꧂","uri":"line://nv/profilePopup/mid=u1d4f6d2ef884cbfa1f04e71136c3c09f"}}]},"hero":{"type":"image","url":"https://thumbs.gfycat.com/ColorlessPinkLangur-size_restricted.gif","size":"full","aspectRatio":"4:3","action":{"type":"uri","uri":"https://line.me/ti/p/a-aemL0Qgf"}},"body":{"type":"box","layout":"horizontal","spacing":"md","contents":[{"type":"separator","color":"#FFFFFF"},{"type":"box","layout":"vertical","flex":0,"contents":[{"type":"separator","color":"#FFFFFF"},{"type":"image","url":"https://profile.line-scdn.net/" + str(pp),"size":"sm","gravity":"bottom"}]},{"type":"separator","color":"#FFFFFF"},{"type":"box","layout":"vertical","flex":2,"contents":[{"type":"text","text":"BOTLINEBY:MASMAX","color":"#FFCC00","size":"sm","weight":"bold","flex":3,"wrap":True,"gravity":"top"},{"type":"separator","color":"#FFFFFF"},{"type":"separator","color":"#FFFFFF"},{"type":"text","text": "{}".format(s),"color":"#FFCC00","size":"sm","weight":"bold","flex":3,"wrap":True,"gravity":"top"},{"type":"separator","color":"#FFFFFF"},{"type":"separator","color":"#FFFFFF"},{"type":"text","text":"ออกสะแล้วบายยนะครับ😎","color":"#FFCC00","size":"sm","weight":"bold","flex":3,"wrap":True,"gravity":"top"},{"type":"separator","color":"#FFFFFF"}]}]},"footer":{"type":"box","layout":"horizontal","contents":[{"type":"button","style":"secondary","color":"#FFFFFF","height":"sm","gravity":"center","flex":1,"action":{"type":"uri","label":"⫷ ติดต่อผู้สร้าง ⫸","uri":"https://line.me/ti/p/a-aemL0Qgf"}},{"type":"spacer","size":"sm"}],"flex":0}}}
        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                ...
                if text.lower() == "ประกาศ":
                    ...
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "Maxgie Botline", "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u1d4f6d2ef884cbfa1f04e71136c3c09f"}}
                  ...
                  if msg._from in admin:
                    ...
                    try:
                      ...
                      try:
                          tagadd["tag"] = text_
                          sa = "「 ตั้งคำแทค 」\nคือ : " + text_
                          data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "꧁༺ช.ป๋อ ฮอก่ะดิ้ว༻꧂", "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u1d4f6d2ef884cbfa1f04e71136c3c09f"}}
                          sendTemplate(to,data)
                      except:
                                ...
                                "contents": [
                                    ...
                                    },
                                    {
                                        ...
                                        "action": {
                                            "type":"uri",
                                            "label":"ผู้สร้าง",
                                            "uri":"https://line.me/ti/p/a-aemL0Qgf"
                                        },
                                    },
                                ]
                            }
...
#=====================================================================
                ...
                if text.lower() == "me1":
                    ...
                    data = {
                        ...
                        "sentBy": {
                             ...
                             "linkUrl": "line://nv/profilePopup/mid=u1d4f6d2ef884cbfa1f04e71136c3c09f"
                        }
                    }
                    sendTemplate(to, data)
                ...
                if text.lower() == "/speed" or text.lower() == "/sp" or text.lower() == "/สปีด":
                    ...
                    data = {"type": "text","text": "{}".format(a),"sentBy": {"label": "%.10f" % (elapsed_time), "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u1d4f6d2ef884cbfa1f04e71136c3c09f"}}
                    #
                    sendTemplate(to,data)
                if text.lower() == "sp" or text.lower() == "speed":
                    start = time.time()
                    maxgie.sendMessage("u1d4f6d2ef884cbfa1f04e71136c3c09f","test speed...")
                    elapsed_time = time.time() - start
                    took = time.time() - start
                    ...
                    try:
                        arr = []
                        owner = "u1d4f6d2ef884cbfa1f04e71136c3c09f"
                        ...
                        data = {
                            ...
                            "sentBy": {
                                 "label": "{}".format(maxgie.getContact(maxgieMID).displayName),
                                 "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),
                                 "linkUrl": "https://line.me/ti/p/a-aemL0Qgf"
                            }
                        }
                        sendTemplate(to, data)
...
#=====================================================================                
                ...
                if text.lower() == "เปิดกันรัน":
                    ...
                    maxgie.sendMessage(to,"เปิดแล้ว🤔")
                if text.lower() == "ปิดกันรัน":
                    sets["autoCancel"]["on"] = False
                    maxgie.sendMessage(to,"ปิดแล้ว😏")
        ...
        if op.type == 25 or op.type == 26:
            ...
            if msg.contentType == 0:
                if text is None:
                    return
                if text.lower() == ".........................":
                    maxgie.sendMessage(to,"[ ꧁༺ช.ป๋อ ฮอก่ะดิ้ว༻꧂ ]\nadmin :\nline.me/ti/p/a-aemL0Qgf")
#========================================================================
            elif msg.contentType == 7: # Content type is sticker
                if settings['Sticker']:
                    if 'STKOPT' in msg.contentMetadata:
        ...
        if op.type == 25:
            ...
            #        sendTemplate(to, data)
                ...
                if msg.text.lower() == "เชคapi":
                    ...
                    data = {"type": "text","text": "{}".format(lisk),"sentBy": {"label": "꧁༺ช.ป๋อ ฮอก่ะดิ้ว༻꧂", "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u1d4f6d2ef884cbfa1f04e71136c3c09f"}}
                    sendTemplate(to,data)
#==============================================================================#
#==============================================================================#
        if op.type == 25:
