...
#=====================================================================
                ...
                if text.lower() == "ออน" or text.lower() == "runtime":
                    ...
                    sendTemplate(to, data)
                    restartBot()
                if text.lower() == "/sp" or text.lower() == "/speed" or text.lower() == "/สปีด":
                    start = time.time()
                ...
                elif text.lower() == "อีสัส":
                            gifnya = ['https://www.picz.in.th/image/cPw5Ul']
                            data = {
                                "type": "template",
